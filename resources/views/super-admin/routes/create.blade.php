    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('super-admin.routes.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="distance_km" id="distance_km" value="{{ old('distance_km') }}" 
                            ...
                            <div>
                                ...
                                <input type="number" name="estimated_duration_minutes" id="estimated_duration_minutes" 
                                       value="{{ old('estimated_duration_minutes') }}" required min="1" max="2880" step="1"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                       placeholder="e.g. 180">
                                <p class="mt-1 text-sm text-gray-500">{{ __('e.g. 180 = 3 hours') }}</p>
