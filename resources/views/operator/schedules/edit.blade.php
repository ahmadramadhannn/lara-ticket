    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('operator.schedules.update', $schedule) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" name="departure_date" id="departure_date" 
                                       value="{{ old('departure_date', $schedule->departure_time->format('Y-m-d')) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" name="base_price" id="base_price" 
                                   value="{{ old('base_price', $schedule->base_price) }}" required min="1000" step="1000"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('base_price')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
